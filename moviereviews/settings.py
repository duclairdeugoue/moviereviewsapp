...
SECRET_KEY = 'django-insecure-8eydpb!fv(h@jyd%u^0zny(0uvcf)fziv1m(8vn@rznwvynap^'
...
# URL path for file upload in django
#MEDIA_ROOT = '/home/duclairdeugoue/moviereviews/media/'
